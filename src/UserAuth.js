        ...
        <MDBCol md='6' className='position-relative'>
          ...
          <MDBCard className='my-5 bg-glass'>
            ...
            {showSuccessAlert && (
              ...
              <MDBRow>
                <MDBCol col='6'>
                  <MDBInput wrUserAutherClass='mb-4' label='First name' id='form1' name='first'  value={first} type='text' onChange={changeHandler}/>
                </MDBCol>

                <MDBCol col='6'>
                  <MDBInput wrUserAutherClass='mb-4' label='Last name' id='form2' name='last' value={last} type='text'onChange={changeHandler}/>
                </MDBCol>
              </MDBRow>
<br></br>
              ...
              <MDBBtn className='w-100 mb-4' size='md' type='Submit' >sign up</MDBBtn>
               <br></br>
              <center> <Link to="/login"><button type="button" class="btn btn-primary">Login</button></Link></center>
